...
(let (
  ...
  (custom-theme-set-faces
   ...
   ;; カッコの対応関係が合った時
   `(show-paren-match    ((t (:foreground "#1B4030" :background "#6DFFBE" :weight bold))))
   ...
   ;; auto-complete の 色設定
   `(ac-candidate-face           ((t (:foreground "#403F2F" :background ,yellow-light :underline (:color ,gray-30 :style line)))))
   `(ac-selection-face           ((t (:background "#000080" :foreground "#ffffff" :underline (:color ,gray-30 :style line)))))
   ...
   ;; popup - auto-complete での document 部分の色
